...
export default function FolioCard({
  ...
  return (
    <Table
      className='table-auto w-11/12 mx-auto overflow-hidden mt-10 bg-flightdeck-darkgold text-black px-6 py-4 rounded-xl hover:bg-flightdeck-lightgold transition-colors duration-300 ease-in-out cursor-pointer w-full'
