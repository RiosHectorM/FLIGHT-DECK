...
export const FormPhoto = (props: { className: string }) => {
  ...
  return (
    <div className="max-w-full w-screen lg:max-w-full lg:flex w-full">
      <div className="border-r border-b border-l border-t border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
        <div className="mb-8">
          <div className="text-gray-900 font-bold text-xl mb-6">Editar Foto de Perfil</div>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              <div className="w-full px-3">
                ...
                <label htmlFor="profilePicture" className="cursor-pointer">
                  ...
                  <input type="file" className="hidden" id="profilePicture" onChange={handleFileSelect} />
                </label>
              </div>
            </div>
            <div className="w-full px-3 flex justify-center items-center mt-12">
              <div className="flex space-x-4">
                <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Guardar</button>
              </div>
            </div>
          </form>
        </div>
