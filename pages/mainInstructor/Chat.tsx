...
const Chat = () => {
  const [messages, setMessages] = useState<ChatMessage[]>([    {      id: '1',      message: 'Hola! ¿Cómo estás?',      author: 'John Doe',      time: '10:00 AM',    },    {      id: '2',      message: 'Muy bien, gracias por preguntar!',      author: 'Jane Doe',      time: '10:02 AM',    },  ]);
  ...
  return (
    <div className='flex flex-col h-full'>
      <div className='bg-white rounded-t-xl flex-2'>
        <div className='flex justify-between items-center h-16 px-4 border-b border-gray-300'>
          <h2 className='text-lg font-medium text-gray-800'>Chat con instructor</h2>
