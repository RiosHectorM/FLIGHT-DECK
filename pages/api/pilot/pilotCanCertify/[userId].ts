...
if (CertifiedHours._sum?.hourCount && CertifiedHours._sum?.hourCount<100 || CertifiedHours._sum?.hourCount===null ){
...
if ( user && user.premium && user.premium===true && user.premiumExpiredDate && user.premiumExpiredDate > today){
